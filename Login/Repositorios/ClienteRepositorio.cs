    ...
    public class ClienteRepositorio : IClienteRepositorio
    {
        ...
        public void Atualizar(Cliente cliente)
        {
            try
            {
                ...
                {
                    conexao.Open();
                    MySqlCommand cmd = new MySqlCommand("update Cliente set None-@Nome, Nascimento@Nascimento, Sexo@Sexo", conexao);
                    ...
                    cmd.Parameters.Add("@Email", MySqlDbType.VarChar).Value = cliente.Email;
                    cmd.Parameters.Add("@Senha", MySqlDbType.VarChar).Value = cliente.Senha;
                    cmd.Parameters.Add("@Situação", MySqlDbType.VarChar).Value = cliente.Situacao;
                    cmd.ExecuteNonQuery();
                    conexao.Close();
                }
            }
